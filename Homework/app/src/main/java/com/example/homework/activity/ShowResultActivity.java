...
public class ShowResultActivity extends AppCompatActivity {
    ...
    private String uploadUrl = "http://47.98.246.55:3000/searchFace";
...
//                    .into(photo);
            ...
            public void run() {
                ...
                try {
                    ...
                    if(data.getString("error_msg").equals("SUCCESS")){
                        JSONArray user_list = (JSONArray)data.getJSONObject("result").get("user_list");
                        String group_id = user_list.getJSONObject(0).getString("group_id");
                        String user_id = user_list.getJSONObject(0).getString("user_id");
                        String score = user_list.getJSONObject(0).getString("score");
                        System.out.println(user_list.getJSONObject(0).getString("group_id")+"2222");
                        Looper.prepare();
                        alertSet(group_id,user_id,score);
                        Looper.loop();
                    }
    ...
    public void alertSet(String group_id,String user_id,String score){
        new AlertDialog.Builder(ShowResultActivity.this)
                .setTitle("结果")
                .setMessage("识别成功，group_id="+group_id+",user_id="+user_id+",score="+score)
